...
const AnimatedPostCard = styled(motion.div)`
  border: 1px solid #999;
  border-radius: 16px;
  overflow: hidden;
  background: white;
  /* Importante para a reacomodação do layout funcionar bem */
  position: relative; 
`;
...
const PostInfo = styled.div`
  display: flex; justify-content: space-between; padding: 24px 24px 0 24px;
...
const PostContent = styled.div`
  padding: 24px; font-size: 18px; line-height: 1.2; white-space: pre-wrap;
`;

const Actions = styled.div` display: flex; gap: 20px; `;

const IconButton = styled.button`
  background: none; font-size: 22px; color: white; display: flex;
